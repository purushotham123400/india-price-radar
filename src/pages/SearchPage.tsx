...
import { Product, CategoryType, RetailerType } from '@/types';
...
const SearchPage: React.FC = () => {
  ...
  const [retailerFilters, setRetailerFilters] = useState<RetailerType[]>([]);
  ...
  const handleRetailerFilter = (retailer: RetailerType) => {
                    ...
                    {categories.map((category) => (
                      <div key={category.id} className="flex items-center">
                        <Checkbox 
                          ...
                          checked={categoryFilters.includes(category.id as CategoryType)}
                          onCheckedChange={() => handleCategoryFilter(category.id as CategoryType)}
                        />
                        <label 
